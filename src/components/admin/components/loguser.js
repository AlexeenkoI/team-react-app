    ...
    render(){
        ...
        const logOverlay = (
            ...
            <ul className="logout-item">
                <li><a ><i className=" fa fa-suitcase"></i>Профиль</a></li>
                <li><a ><i className="fa fa-cog"></i> Настройки</a></li>
                <li><a onClick={(e)=>{this.props.logout()}}><i className="fa fa-key"></i> Выйти</a></li>
            </ul>
            </Popover>
        )
        return(
